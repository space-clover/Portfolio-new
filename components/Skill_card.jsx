...
const Skill_card = ({titulo, descripcion}) => {
    return (
        ...
        hover:shadow-md hover:shadow-slate-400  transition duration-300 rounded-xl my-2'> 
            <h3 className=' lg:w-1/4 text-lg text-center flex items-center mr-4 text-dark font-bold'>{titulo}</h3>
            <p className=' lg:w-3/4 text-sm text-primary mt-2 text-justify' >{descripcion}</p>
        </motion.div>
    )
}
